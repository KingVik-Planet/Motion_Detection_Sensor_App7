...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\KingVik Planet\PycharmProjects\Motion_Detection_Sensor_App7'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\KingVik Planet\PycharmProjects\Motion_Detection_Sensor_App7\Scripts\deactivate.nu'
